...
// Types for the organization context
interface Organization {
  id: string
  name: string
  type: "accounting_firm" | "client" | "platform"
...
interface OrganizationAction {
  type: "SET_ORGANIZATIONS" | "ADD_ORGANIZATION" | "UPDATE_ORGANIZATION" | "DELETE_ORGANIZATION"
  payload: any
}

interface UserAction {
  type: "SET_USERS" | "ADD_USER" | "UPDATE_USER" | "DELETE_USER"
  payload: any
}
...
export function OrganizationProvider({ children, initialData }: OrganizationProviderProps) {
  ...
  const contextValue = useMemo(
    ...
    [organizations, users, currentOrganization, currentUser, actions],
  )
